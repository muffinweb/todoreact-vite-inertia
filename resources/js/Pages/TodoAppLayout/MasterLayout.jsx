            ...
            <nav className="bg-white shadow" role="navigation">
                <div className="container mx-auto p-4 flex flex-wrap items-center md:flex-no-wrap">
                    <div className="mr-4 md:mr-8">
                        <a href="#" rel="home">
                            <svg className="w-10 h-10 text-purple-600" width="54" height="54" viewBox="0 0 54 54"
                    ...
                    <div className="w-full md:w-auto md:flex-grow md:flex md:items-center">
                        <ul className="flex flex-col mt-4 -mx-4 pt-4 border-t md:flex-row md:items-center md:mx-0 md:mt-0 md:pt-0 md:mr-4 lg:mr-8 md:border-0">
                            ...
                            <li>
                                <a className="block px-4 py-1 md:p-2 lg:px-4 text-purple-600" href="#"
                                   title="Active Link">Active Link</a>
                            </li>
                            <li>
                                <a className="block px-4 py-1 md:p-2 lg:px-4" href="#" title="Link">Link</a>
                            </li>
                        ...
                        <ul className="flex flex-col mt-4 -mx-4 pt-4 border-t md:flex-row md:items-center md:mx-0 md:ml-auto md:mt-0 md:pt-0 md:border-0">
                            ...
                            <li>
                                <Link className="block px-4 py-1 md:p-2 lg:px-4 text-purple-600" href="/todolist"
                                   title="Active Link">Go To Todos</Link>
                            </li>
                            <li>
                                <a className="block px-4 py-1 md:p-2 lg:px-4" href="#" title="Link">Link</a>
                            </li>
